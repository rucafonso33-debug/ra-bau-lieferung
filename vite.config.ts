  ...
  return {
    ...
    load(id) {
      ...
      return partFiles
        ...
        .join('')
        .replace("import { constructionCategories, interiorCategories } from './data';", "import { constructionCategories, interiorCategories } from './luxuryData';")
        ...
        .replace("['mosaics', 'Badezimmer']", "['mosaics', 'Badezimmer']")
        ...
        .replace("copy: 'Ein visuell starkes Badmöbel als Mittelpunkt, ergänzt durch moderne Duschsysteme, Armaturen, WCs und Duschwannen.'", "copy: 'Kuratierten Raumkonzepte zeigen reale Produkte in ihrem stärksten Zusammenspiel. Der Kunde kann das komplette Konzept anfragen oder einzelne Bestandteile entfernen.'")
        ...
        .replace("kicker: 'Sparte 05 · Einzelprodukt oder Komplettbad'", "kicker: 'Sparte 05 · Kuratierte Raumkonzepte'")
        .replace("title: 'Badmöbel, Armaturen, Dusche und WC sinnvoll kombinieren'", "title: 'Komplette Räume sehen, Produkte auswählen und individuell anfragen'")
        .replace("copy: 'Die Auswahl beginnt mit dem visuellen Mittelpunkt des Bads und führt danach zu passenden Dusch-, Armaturen- und Sanitärlösungen.'", "copy: 'Jedes Konzept zeigt eine hochwertige Materialkombination für Bad, Wohnen oder Küche. Produkte lassen sich gemeinsam oder einzeln in die Projektanfrage übernehmen.'")
        .replace(
