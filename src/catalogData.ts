...
export const products: Product[] = [
  ...
  { id: 'mo-bluenza', category: 'mosaik', name: 'Light Sand Modular', description: 'Modulares Steinmosaik in warmem Sandton für Duschen, Nischen und koordinierte Spa-Flächen.', image: '/images/products-2026/mosaic-bluenza.webp', imageAlt: 'Modulares Mosaik in heller warmer Sandsteinoptik', specs: ['ca. 30 × 30 cm', 'Steinoptik', 'matt'] },
  { id: 'mo-mastery', category: 'mosaik', name: 'Marble Mix', description: 'Fein abgestimmter Mix aus hellen Marmortönen für elegante Akzentflächen und bodengleiche Duschen.', image: '/images/products-2026/mosaic-mastery.webp', imageAlt: 'Helles geometrisches Mosaik mit feiner Marmorzeichnung', specs: ['Netzmatte', 'Marmoroptik', 'Nassbereich'] },
